...
EXPERIMENT_MATRIX = [
    ("configs/pde/burgers_1d.yaml", "baseline_burgers"),
    ("configs/ablation/burgers_no_conflict_weight.yaml", "burgers_no_conflict_weight"),
    ("configs/ablation/burgers_no_rule_balance.yaml", "burgers_no_rule_balance"),
    ("configs/pde/heat_1d.yaml", "baseline_heat"),
    ("configs/ablation/heat_no_conflict_weight.yaml", "heat_no_conflict_weight"),
    ("configs/ablation/heat_no_rule_balance.yaml", "heat_no_rule_balance"),
]
...
def main() -> None:
    ...
    p.add_argument("--epochs", type=int, default=60000, help="override epochs for longer-horizon runs")
    args = p.parse_args()
